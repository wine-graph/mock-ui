...
const VisitorHome: React.FC<HomeProps> = ({userType}) => {
    const renderWelcomeMessage = () => {
        switch (userType) {
            case UserType.Enthusiast:
                return <><h4>Welcome, Wine Enthusiast!</h4><p>Track your favorite wines, write reviews, and discover new
                    favorites.</p></>;
            case UserType.Producer:
                return <><h4>Welcome, Wine Producer!</h4><p>Manage your wine inventory, sync with Shopify, and connect
                    with retailers.</p></>;
            case UserType.Retailer:
                return <><h4>Welcome, Wine Retailer!</h4><p>Manage your inventory, sync with Square, and discover new
                    producers.</p></>;
            default:
                return <><h4>Welcome to the Wine Platform</h4><p>Discover wines, learn about producers and regions — no
                    login required.</p></>;
        }
    };
                        ...
                        <div className="card-body">
                            <div className="row">
                                {mockWines.slice(0, 3).map((wine) => (
                                    <div key={wine.id} className="col-md-4 mb-3">
                                        <div className="card h-100">
                                            <div className="card-body">
                                                <h6>{wine.name}</h6>
                                                <p className="text-muted">{wine.subarea} • {wine.producer}</p>
                                                <p>{wine.description?.slice(0, 60) || 'A delightful wine with notes of...'}...</p>
                                            </div>
                    ...
                    <div className="card">
                        ...
                        <div className="card-body">
                            <ul className="list-group">
                                <li className="list-group-item">New producer joined: {mockProducers[0].name}</li>
                                <li className="list-group-item">New wine added: {mockWines[0].name}</li>
