...
const EnthusiastMarketplace: React.FC = () => {
  ...
  return (
    <div className="container py-4">
      <h4 className="fs-4">Wine Finder</h4>
      <p className="small">
        Find local wine retailers in your area. Save your favorites for quick
        access.
      </p>
        ...
        <div className="card-body p-0">
          ...
          >
            ...
            <p className="text-muted">
              Interactive map showing wine retailers in your area
            </p>
          </div>
        </div>
      </div>
        ...
        {filteredRetailers.map((retailer) => {
          ...
          return (
            <div key={retailer.id} className="col-lg-4 col-md-6 mb-4">
              <div
                className={`card h-100 ${isFavorite ? "border-primary" : ""}`}
              >
        ...
        {filteredRetailers.length === 0 && (
          <div className="col-12">
            <div className="alert alert-info">
              No retailers found matching your search criteria. Try adjusting
              your filters.
            </div>
          </div>
        )}
