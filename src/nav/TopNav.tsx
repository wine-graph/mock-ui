...
const TopNav: React.FC<TopNavProps> = ({ userType, setUserType }) => {
  ...
  const [filteredWines, setFilteredWines] = useState<Search[]>([]);
  ...
  return (
    <nav className="navbar navbar-light bg-light px-3 sticky-top">
      <span className="navbar-brand mb-0 h1">🍇 Wine Graph 🍇</span>
      <div className="search position-relative w-25">
        <input
          className="form-control me-2 w-100 small"
          type="search"
        ...
        >
          ...
          <button
            className={`dropdown-item ${
              userType === UserType.Visitor ? "active" : ""
            }`}
          ...
          <button
            className={`dropdown-item ${
              userType === UserType.Enthusiast ? "active" : ""
            }`}
          ...
          <button
            className={`dropdown-item ${
              userType === UserType.Producer ? "active" : ""
            }`}
          ...
          <button
            className={`dropdown-item ${
              userType === UserType.Retailer ? "active" : ""
            }`}
